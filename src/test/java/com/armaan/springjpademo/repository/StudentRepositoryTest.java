...
//                .guardianMobile("01738493847")
    ...
    public void printGetStudentFirstNameByEmailAddress() {
        String firstNameByEmailAddress = studentRepository.getStudentFirstNameByEmailAddress("sam@gmail.com");
    ...
    public void printGetStudentByEmailAddressNativeNamedParam() {
        Student student = studentRepository.getStudentByEmailAddressNativeNamedParam("sam@gmail.com");

        System.out.println("student = " + student);
    }

    @Test
    public void updateStudentNameByuEmailId() {
        studentRepository.updateStudentNameByEmailId("Patrick Bateman", "mike@gmail.com");
    }
}